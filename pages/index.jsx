    ...
    return (
        <>
            ...
            <main className={styles.main}>
                ...
                <p className={styles.desc}>Quotes get Automatically updated daily, around 00:00 AM. This is the Demonstration for how easily we can use Next.js and GitHub Actions to Create Sites with Dynamic content <b>without any server</b> and schedule <a target="_blank" rel="noopener noreferrer" href="https://crontab.guru/#0_0_*_*_*">CRON Job</a> for auto build at specific time/interval of time.</p>
